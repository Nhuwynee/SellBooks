        ...
        <div class="modal-content">
            <form action="" class="add-product-form">
                <div class="modal-content-left">
                    ...
                    <div class="form-group file">
                        <label for="up-file-audio" class="form-label-file"><i class="fa-regular fa-cloud-arrow-up"></i>Chọn file audio</label>
                        <input accept="audio/*" id="up-file-audio" name="up-file-audio" type="file" class="form-control">
                    </div>
                    <div class="form-group file">
                        <label for="up-file-doc" class="form-label-file"><i class="fa-regular fa-cloud-arrow-up"></i>Tải lên file đọc thử</label>
                        <input accept=".doc,.docx" id="up-file-doc" name="up-file-doc" type="file" class="form-control">
                    </div>
                </div>
                <div class="modal-content-right">
                    <div class="form-group">
                        <label for="ten-sach" class="form-label">Tên sách</label>
                        <input id="ten-sach" name="ten-sach" type="text" placeholder="Nhập tên sách" class="form-control">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="tac-gia" class="form-label">Tác giả</label>
                        <input id="tac-gia" name="tac-gia" type="text" placeholder="Nhập tên tác giả" class="form-control">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Thể loại</label>
                        <select name="the-loai" id="chon-sach" class="form-control">
                            <option value="">-- Chọn thể loại --</option>
                            <option value="lop-10">Lớp 10</option>
                            <option value="lop-11">Lớp 11</option>
                            <option value="lop-12">Lớp 12</option>
                            <option value="sach-khac">Sách khác</option>
                        </select>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="so-luong" class="form-label">Số lượng</label>
                        <input id="so-luong" name="so-luong" type="number" placeholder="Nhập số lượng" class="form-control">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="gia-moi" class="form-label">Giá bán</label>
                        <input id="gia-moi" name="gia-moi" type="number" placeholder="Nhập giá bán" class="form-control">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="mo-ta" class="form-label">Mô tả</label>
                        <textarea class="product-desc" id="mo-ta" placeholder="Nhập mô tả sách..." class="form-control"></textarea>
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="noi-dung-doc-thu" class="form-label">Nội dung đọc thử</label>
                        <textarea class="product-excerpt" id="noi-dung-doc-thu" placeholder="Nhập nội dung đọc thử..." class="form-control" rows="10"></textarea>
                        <span class="form-message"></span>
                    </div>
